    ...
    class Program
    {
        internal class Window3D : GameWindow
        {
            ...
            protected override void OnUpdateFrame(FrameEventArgs e)
            {
                ...
                //Realizeaza o dublura a cubului, si tot mai apoi o inlatura
                ...
                //Muta cubul la stanga
                if (keyboard[Key.A])
                {
                    transStep--;
                }

                //Muta cubul la dreapta
                if (keyboard[Key.D])
                {
                    transStep++;
                }
